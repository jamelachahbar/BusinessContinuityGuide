...
const bcpChecklist: { component: string; description: string }[] = [
  ...
  { component: 'Plan Scope & Objectives', description: 'Define what\u2019s covered and goals' },
...
/* ────────────────────────────────────────────────────
   2. Risk Assessment — risk levels & scenarios
   ──────────────────────────────────────────────────── */
...
/* ────────────────────────────────────────────────────
   4. Business Critical Function Calendar
   ──────────────────────────────────────────────────── */
...
const testStatusData: { application: string; lastFailover: string; lastRecovery: string; nextScheduled: string; status: string; statusIcon: string }[] = [
  { application: 'Azure Platform Landing Zone', lastFailover: '2026-01-15', lastRecovery: '2026-02-10', nextScheduled: '2026-04-15', status: 'On Track', statusIcon: '\u2705' },
  { application: 'Mars Travel Bookings', lastFailover: '2026-01-20', lastRecovery: '2026-02-15', nextScheduled: '2026-04-20', status: 'On Track', statusIcon: '\u2705' },
  { application: 'Warehouse Inventory', lastFailover: '2025-10-01', lastRecovery: '2025-11-05', nextScheduled: '2026-03-15', status: 'Overdue', statusIcon: '\u274C' },
  { application: 'Order Fulfillment', lastFailover: '2025-12-01', lastRecovery: '2026-01-10', nextScheduled: '2026-04-01', status: 'Upcoming', statusIcon: '\u26A0\uFE0F' },
  { application: 'Lunar Orbit Control', lastFailover: '2026-03-01', lastRecovery: '2026-03-05', nextScheduled: '2026-06-01', status: 'On Track', statusIcon: '\u2705' },
  { application: 'Complaints Management', lastFailover: '\u2014', lastRecovery: '\u2014', nextScheduled: '2026-05-01', status: 'Upcoming', statusIcon: '\u26A0\uFE0F' },
]
...
const maintenanceScheduleData: { document: string; frequency: string; lastReview: string; nextReview: string; owner: string; approver: string; status: string; statusIcon: string; statusColor: string }[] = [
  { document: 'Business Continuity Plan', frequency: 'Annually', lastReview: '2025-06-15', nextReview: '2026-06-15', owner: 'BC Manager', approver: 'CTO', status: 'Current', statusIcon: '\u2705', statusColor: '#28a745' },
  { document: 'Business Risk Assessment', frequency: 'Semi-annually', lastReview: '2025-09-01', nextReview: '2026-03-01', owner: 'Risk Manager', approver: 'CISO', status: 'Due Soon', statusIcon: '\u26A0\uFE0F', statusColor: '#ffc107' },
  { document: 'MBCO Recovery Order', frequency: 'Quarterly', lastReview: '2025-12-01', nextReview: '2026-03-01', owner: 'IT Director', approver: 'CTO', status: 'Overdue', statusIcon: '\u274C', statusColor: '#dc3545' },
  { document: 'BIA Portfolio Summary', frequency: 'Annually', lastReview: '2025-01-15', nextReview: '2026-01-15', owner: 'BC Manager', approver: 'CFO', status: 'Current', statusIcon: '\u2705', statusColor: '#28a745' },
  { document: 'BCDR Dashboard', frequency: 'Monthly', lastReview: '2026-02-28', nextReview: '2026-03-31', owner: 'Operations', approver: 'IT Director', status: 'Current', statusIcon: '\u2705', statusColor: '#28a745' },
  { document: 'Critical Function Calendar', frequency: 'Quarterly', lastReview: '2025-12-15', nextReview: '2026-03-15', owner: 'BC Manager', approver: 'CTO', status: 'Due Soon', statusIcon: '\u26A0\uFE0F', statusColor: '#ffc107' },
  { document: 'Training & Awareness', frequency: 'Annually', lastReview: '2025-07-01', nextReview: '2026-07-01', owner: 'HR / BC Manager', approver: 'CTO', status: 'Current', statusIcon: '\u2705', statusColor: '#28a745' },
]
    ...
    <div className={styles.container}>
      ...
      <Accordion collapsible multiple>
        ...
        {/* ================================================================
            1. BCP DOCUMENT
            ================================================================ */}
        <AccordionItem value="bcp-document">
          <AccordionHeader>1. Business Continuity Plan (BCP) Document</AccordionHeader>
          <AccordionPanel>
        ...
        <AccordionItem value="risk-assessment">
          <AccordionHeader>2. Business Risk Assessment</AccordionHeader>
          <AccordionPanel>
            <p className={styles.subsectionDesc}>
        ...
        {/* ================================================================
            3. MBCO PLANNING — Recovery Order
            ================================================================ */}
        <AccordionItem value="mbco-planning">
          <AccordionHeader>3. MBCO Planning &mdash; Application Recovery Order</AccordionHeader>
          <AccordionPanel>
            <p className={styles.subsectionDesc}>
        ...
        {/* ================================================================
            4. BUSINESS CRITICAL FUNCTION CALENDAR
            ================================================================ */}
        <AccordionItem value="critical-calendar">
          <AccordionHeader>4. Business Critical Function Calendar</AccordionHeader>
          <AccordionPanel>
            <p className={styles.subsectionDesc}>
        ...
        {/* ================================================================
            5. BIA PORTFOLIO SUMMARY
            ================================================================ */}
        <AccordionItem value="bia-portfolio">
          <AccordionHeader>5. Business Impact Analysis &mdash; Portfolio Summary</AccordionHeader>
          <AccordionPanel>
            <p className={styles.subsectionDesc}>
        ...
        {/* ================================================================
            6. BCDR DASHBOARD
            ================================================================ */}
        <AccordionItem value="bcdr-dashboard">
          <AccordionHeader>6. BCDR Dashboard</AccordionHeader>
          <AccordionPanel>
            <p className={styles.subsectionDesc}>
                  ...
                  <tbody>
                    {testStatusData.map((row, i) => (
                      <tr key={i}>
                        ...
                        <td className={styles.tdCenter}>{row.statusIcon} {row.status}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
        ...
        {/* ================================================================
            7. MAINTAIN BUSINESS CONTINUITY
            ================================================================ */}
        <AccordionItem value="maintain-bc">
          <AccordionHeader>7. Maintain Business Continuity</AccordionHeader>
          <AccordionPanel>
            <p className={styles.subsectionDesc}>
            ...
            <div className={styles.legend}>
              <div className={styles.legendItem}>{'\u2705'} Current</div>
              <div className={styles.legendItem}>{'\u26A0\uFE0F'} Due Soon</div>
              <div className={styles.legendItem}>{'\u274C'} Overdue</div>
            </div>
                ...
                <tbody>
                  {maintenanceScheduleData.map((row, i) => (
                    <tr key={i}>
                      ...
                      <td className={styles.tdCenter}>
                        <Badge appearance="filled" style={{ backgroundColor: row.statusColor, color: row.statusColor === '#ffc107' ? '#1a1a1a' : '#ffffff' }}>
